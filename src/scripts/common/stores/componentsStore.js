;(function () {
    ...
    function add(name, fn) {
         ...
         *
         * Например - работать только с событиями... Такое-себе реактивное программирование... Но как я понимаю,
         * это очень фиговая тема будет, так как будет сложно отследить кто и как вызвал то или иное событие.   ]
         * */
